@echo off
title Fishbowl Inventory Availability Launcher
set "FILE=%~dp0InventoryAvailability.htm"
set "TMPDIR=%TEMP%\FBInventoryAvailability"

echo =========================================
echo  Fishbowl Inventory Availability (Standalone)
echo =========================================
echo.
